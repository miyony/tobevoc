if (nexacro.Environment)
{
    ...
    {
        this.set_themeid("theme::TMSN");
        this.set_datatyperule("2.0");
        this.set_userfontid("font::Cafe24SsurroundAir.xfont");
    };
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("VOC", "form", "./VOC/", "session", null, "", "0", "0");
        nexacro._addService("cmm", "form", "./cmm/", "session", null, "", "0", "0");
        nexacro._addService("lib", "js", "./lib/", "dynamic", null, "", "0", "0");
        nexacro._addService("Xcss", "file", "./Xcss/", "none", null, "", "0", "0");
        nexacro._addService("Img", "file", "./Img/", "none", null, "", "0", "0");
        nexacro._addService("Icon", "file", "./Icon/", "none", null, "", "0", "0");
    ...
    env.on_loadVariables = function ()
    {
        ...
        // Cookies
        nexacro.setCookieVariable("userId", "", "false");
        // HTTP Header
