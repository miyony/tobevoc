(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1280,37,this,function(p){});
        ...
        * FORM EVENT 영역(onload)
        /***********************************************************************************************/
        this.cmmPaging_onload = function(obj,e)
        {
        ...
        ************************************************************************************************/
        ...
        /*     var objDivPaging = this.divPage;*/
            ...
            if (sPageView == "all" || sPageView == "number")
            {
        		...
        		objBtnBefore.set_cssclass("btn_MTF_prevBtn");
        		...
        		objBtnNext.set_cssclass("btn_MTF_nextBtn");
        		//objBtnNext.set_text(">");
        ...
        {
            this.addEventHandler("onload",this.cmmPaging_onload,this);
        };
