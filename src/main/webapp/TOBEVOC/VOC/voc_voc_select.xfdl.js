(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sub_stat4","10","126","74","50",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("조회결과");
            ...
            obj = new Edit("search_user_id_edit","1070","55","140","20",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("voc_voc_select.xfdl", function() {
        /************************************************************************************************
        * FORM 변수 선언 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        this.voc_voc_select_onload = function(obj,e)
        {
        ...
        ************************************************************************************************/
        ...
        this.init_btn_onclick = function(obj,e)
        {
        	...
        	this.search_user_id_edit.set_value("");
        ...
        ************************************************************************************************/
        /* selectVoc */
        this.selectVoc = function(){
        	var objForm = this.Div00.form.calForm.form;

        	var ststDttm = objForm.fnGetFromDate();
        	var endDttm = objForm.fnGetToDate();
        	var chrgUser = this.search_user_id_edit.text;
        ...
        ************************************************************************************************/
        ...
        this.fn_popupSearch = function(sPopId, sRtn)
        {
        	...
        	if(sPopId == "userSearch"){
        		if( sRtn.length> 0 ){
        			...
        			this.search_user_id_edit.set_value(arrRtn[1]);
        ...
        {
            this.addEventHandler("onload",this.voc_voc_select_onload,this);
        ...
        this.loadIncludeScript("voc_voc_select.xfdl");
