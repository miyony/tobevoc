(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("Grid_Wf_Date","11","75","461","685",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new Button("Btn_Save",null,null,"65","30","79","725",null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("저장");
            ...
            obj = new Button("Btn_Close",null,null,"65","30","6","725",null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("닫기");
            obj.set_cssclass("btn_WF_basic01");
            this.addChild(obj.name, obj);

            obj = new Button("btn_add",null,"47","26","26","613",null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_cssclass("btn_WF_add");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Button("btn_del",null,"47","26","26","579",null,null,null,null,null,this);
            obj.set_taborder("13");
            ...
            obj = new Static("sub_stat1_00","496","27","74","50",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_text("등록");
            obj.set_cssclass("sta_WF_SubtitleDown");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("WM_Regular_Schedule.xfdl", function() {
        /************************************************************************************************
        * FORM 변수 선언 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        {
        	this.Static_Header.set_text("정기 업무");
        ...
        this.btn_del_onclick = function(obj,e)
        {
        	...
        	if(this.confirm("정기일정을 삭제하시겠습니까?")){
        		if(jobId == "" || jobId == "undefined" || jobId == null ){
        			...
        			this.ds_sch_date.setColumn(row, "DEL_YN", "Y");
        			var userId = this.objApp.gds_login_user_info.getColumn(0,"USER_ID");
        ...
        ************************************************************************************************/
        this.selectRegularSch = function(){
        	...
        	var strSvcUrl   = "SVC::Search_Job_Schedule.jsp";
        	var inData      = "";
        	var outData     = "ds_sch_date=outds";
        ...
        this.insertRegularSch = function(){
        	...
        	var strSvcUrl   = "SVC::Save_Job_Schedule.jsp";
        	var inData      = "inds=ds_sch_date:u";
        	var outData     = "";
        	var strArg      = "complate=N";
        	var callBackFnc = "fnCallback";
        ...
        */
        ...
        this.loadIncludeScript("WM_Regular_Schedule.xfdl");
